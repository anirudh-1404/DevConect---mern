    ...
    return (
        <div className="min-h-screen bg-[#020617] text-white px-4 sm:px-6 py-16">
            <div className="max-w-7xl mx-auto">
                ...
                bg-gray-900/50 border border-cyan-800/40 
              ...
              "
                  ...
                  hover:shadow-cyan-500/25 hover:scale-105 
...
transition-all duration-300 cursor-pointer
                ${filterType === type
                                    ...
                                    : "bg-gray-900/50 border border-cyan-800/40 text-gray-400 hover:border-cyan-500/50 hover:text-cyan-400"
                                }
`}
                        >
                            {type}
                    ...
                    <>
                        <div className="flex justify-between items-center mb-6">
                            <p className="text-gray-400">
                                Showing <span className="text-cyan-400 font-semibold">{filteredJobs.length}</span> {filteredJobs.length === 1 ? 'job' : 'jobs'}
                            </p>
                        </div>
