...
const TrustedBy = () => (
  <div className="py-10 border-y border-white/5 bg-[#020617]/50 backdrop-blur-sm">
    ...
    <div className="flex justify-center gap-12 md:gap-24 flex-wrap px-6 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
      {[
        ...
        <div key={i} className="flex items-center gap-2 group cursor-default">
          <span className="text-white group-hover:text-cyan-400 transition-colors">{brand.icon}</span>
...
const Home = () => {
  return (
    <div className="bg-[#020617] min-h-screen selection:bg-cyan-500/30">
      <Hero />
      <TrustedBy />
      <ExploreSection />
      <TestimonialsSection />
      ...
      <section className="py-24 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <a href="/register" className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white transition-all duration-200 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl hover:scale-105 hover:shadow-[0_0_40px_-10px_rgba(6,182,212,0.5)]">
            Join DevConnect Now
          </a>
        </div>
      </section>
